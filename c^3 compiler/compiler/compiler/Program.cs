...
namespace compiler
{
    class Program
    {
        ...
        static bool start_ICG()
        {
            CFG_ICG cfg = new CFG_ICG();
            if ((cfg.my_main()) && (index + 1 == All_Tokens.Count))
            {
                StreamWriter icg = new StreamWriter("ICG.txt");
                foreach (string item in cfg.ICG)
                {
                    icg.WriteLine(item);
                }
                icg.Flush();
        ...
        static bool start_semantic()
        {
            CFG_semantic cfg = new CFG_semantic();
            if ((cfg.my_main()) && (index + 1 == All_Tokens.Count))
            {
        ...
        static bool  start_syntax()
        {
            ...
            Data.all_classes_syntax.Add(new L1("line", "class"));
            Data.all_classes_syntax.Add(new L1("num", "class"));
            Data.all_classes_syntax.Add(new L1("bignum", "class"));

            Data.all_classes_semantic.Add(new L1("c3", "class"));
            Data.all_classes_semantic[0].l2_list.Add(new L2("Main", "num"));
            CFG_syntax cfg = new CFG_syntax();
            if ((cfg.my_main()) && (index+1 == All_Tokens.Count))
            {
                return true;
            }
        ...
        static void Read_token_classpart()
        {
            ...
            StreamReader read = new StreamReader("Tokens.txt");
