...
namespace compiler
{
    class CFG_semantic : Program
    {
        ...
        public bool OE_equal(string right_type)
        {
            ...
            if (All_Tokens[index].class_part == "=")
            {
                ...
                if (OE())
                {
                    ...
                    if (stack_opr.Count > 0)
                    {
                        ...
                        if (compatiblity(left_type, right_type, "=").ToString() != "Not Compatible" && LeftCompablity==true)
                        {
                            if (All_Tokens[index].class_part == ";")
                            {
                                index++;
            ...
            if (All_Tokens[index].class_part == ";" && LeftCompablity == true)
            {
                index++;
                return true;
            }
...
{ "num", "num","+", "num" }, { "num", "num", "-", "num" }, { "num", "num", "*", "num" }, { "num", "num", "/", "bignum" },{ "num", "num", "%", "num" },
